class Incident {
  ...
  factory Incident.fromJson(Map<String, dynamic> json) {
    ...
    // New path: incidents → tenancies → properties (after migration)
    final tenancyRaw = json['tenancy'];
    if (tenancyRaw is Map<String, dynamic>) {
      final nestedProp = tenancyRaw['property'];
      if (nestedProp is Map<String, dynamic>) {
        propertyAddress = nestedProp['address_line_1'] as String?;
        propertyPostcode = nestedProp['postcode'] as String?;
      }
    }
